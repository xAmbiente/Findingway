...
- [WELCOME TO FINDINGWAY!](#welcome-to-findingway)
...
- [WHO IS FINDINGWAY'S EEA REPRESENTATIVE?](#who-is-findingways-eea-representative)
...
## WELCOME TO FINDINGWAY!

Findingway provides a chat bot for the [Discord](https://discord.com/privacy) chat platform, (the "Bot"), a website that
serves as a dashboard (the "Site") and various related services (collectively, the "Service(s)"). The Service is
operated by Findingway (the "Company", "we" or "us") for users of the Service ("you" or the "user(s)"). This privacy policy
sets forth our policy with respect to information that is collected from visitors to the Site and users of the Bot
and/or the Services. Under applicable law, Findingway is the "data controller" of [Discord](https://discord.com/privacy)
...
information to us please contact us at theambiente@icloud.com. Note: In some countries, the age of digital consent is
older than 13. If you are in those countries, you must be at least that age to use the Services. For example, for
residents of the EEA, where processing of personal information is based on consent, Findingway will not knowingly engage in
...
If you would like to submit a data access request, you can do so by sending an email to theambiente@icloud.com. Upon
...
You can request modifications to your data from us directly. Please write us at theambiente@icloud.com with the words
...
## WHO IS FINDINGWAY'S EEA REPRESENTATIVE?
...
the Services. You may contact us as follows: theambiente@icloud.com.
